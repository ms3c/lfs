            ...
            echo '<div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    ...
                    <div class="text-center py-4">
                        <a class="h6 text-decoration-none text-truncate" href="">' . $row["item_name"] .'<img src="img/new_flash.gif" width="44px" height="33px"> </a><span class="lost-badge">Lost</span><br>
